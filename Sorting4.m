...
%    20.0000    10    2    4    1   82.0000;...
%    21.0000    2    5    8    3   82.0000;...
%    22.0000    7    2    8    9   72.0000;...
%    23.0000    4    6    1    2   83.0000;...
% ]; %For Testing

% Maximum Possible House Happiness
% This is no longer as scientific because there is not a definite number of
% students in each house. House size will vary by one.
max_hap=[];
for y = 1:4
